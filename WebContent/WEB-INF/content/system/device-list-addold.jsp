...
<html>
	...
	<body>
		<custom:navigation father="Organization Management" model="Device" operate="Add" saveMethod="sub2();" homePath="system/device-list" />
...
<script type="text/JavaScript">
	...
	function change(){
		...
		var initcode;
		var newop;
		if($("#cid\\["+ind+"\\]").val()!=null&&$("#cid\\["+ind+"\\]").val()!=""&&$("#cid\\["+ind+"\\]").val()!="-1"){
			initcid = $("#cid\\["+ind+"\\]").val();
