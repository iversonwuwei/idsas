...
<body>
	...
	<form name="queryResult" action="<%=basePath%>vehicle/vehicle-list!save" method="post">
		<div class="search" style="font-size: 15px;">
			...
			<input type="radio" onclick="checkit(3)">2×4</input>&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" checked="checked">4×4</input>&nbsp;&nbsp;&nbsp;&nbsp;
			</div>
		</div>
		<div class="pop_one">
			<ul>
			...
			<ul>
				<li style="border-left:  solid 1px #000;">
					<s:include value="/common/ipCam_mod.jsp">
						<s:param name="id" value="'channel9'" /> 
						<s:param name="ip" value="%{cameras[8].ipaddress}" />	
						<s:param name="channel" value="'9'" />	
						<s:param name="username" value="%{cameras[8].username}" /> 
						<s:param name="password" value="%{cameras[8].password}" />
					</s:include>
				</li>
				<li>
					<s:include value="/common/ipCam_mod.jsp">
						<s:param name="id" value="'channel10'" /> 
						<s:param name="ip" value="%{cameras[9].ipaddress}" />	
						<s:param name="channel" value="'10'" />	
						<s:param name="username" value="%{cameras[9].username}" /> 
						<s:param name="password" value="%{cameras[9].password}" />
					</s:include>
				</li>
				<li>
					<s:include value="/common/ipCam_mod.jsp">
						<s:param name="id" value="'channel11'" /> 
						<s:param name="ip" value="%{cameras[10].ipaddress}" />	
						<s:param name="channel" value="'11'" />	
						<s:param name="username" value="%{cameras[10].username}" /> 
						<s:param name="password" value="%{cameras[10].password}" />
					</s:include>
				</li>
				<li>
					<s:include value="/common/ipCam_mod.jsp">
						<s:param name="id" value="'channel12'" /> 
						<s:param name="ip" value="%{cameras[11].ipaddress}" />	
						<s:param name="channel" value="'12'" />	
						<s:param name="username" value="%{cameras[11].username}" /> 
						<s:param name="password" value="%{cameras[11].password}" />
					</s:include>
				</li>
			</ul>
			<ul>
				<li style="border-left:  solid 1px #000;">
					<s:include value="/common/ipCam_mod.jsp">
						<s:param name="id" value="'channel13'" /> 
						<s:param name="ip" value="%{cameras[12].ipaddress}" />	
						<s:param name="channel" value="'13'" />	
						<s:param name="username" value="%{cameras[12].username}" /> 
						<s:param name="password" value="%{cameras[12].password}" />
					</s:include>
				</li>
				<li>
					<s:include value="/common/ipCam_mod.jsp">
						<s:param name="id" value="'channel14'" /> 
						<s:param name="ip" value="%{cameras[13].ipaddress}" />	
						<s:param name="channel" value="'14'" />	
						<s:param name="username" value="%{cameras[13].username}" /> 
						<s:param name="password" value="%{cameras[13].password}" />
					</s:include>
				</li>
				<li>
					<s:include value="/common/ipCam_mod.jsp">
						<s:param name="id" value="'channel15'" /> 
						<s:param name="ip" value="%{cameras[14].ipaddress}" />	
						<s:param name="channel" value="'15'" />	
						<s:param name="username" value="%{cameras[14].username}" /> 
						<s:param name="password" value="%{cameras[14].password}" />
					</s:include>
				</li>
				<li>
					<s:include value="/common/ipCam_mod.jsp">
						<s:param name="id" value="'channel16'" /> 
						<s:param name="ip" value="%{cameras[15].ipaddress}" />	
						<s:param name="channel" value="'16'" />	
						<s:param name="username" value="%{cameras[15].username}" /> 
						<s:param name="password" value="%{cameras[15].password}" />
					</s:include>
				</li>
			</ul>
		</div>
