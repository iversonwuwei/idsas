...
<html>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>css/flot.css" />
		...
		<script language="javascript" type="text/javascript" src="<%=basePath%>scripts/specific/comparison/speeding-violations-pkm.js"></script>
    </head>
	<body>
		<custom:navigation father="Department Report" model="Speeding Violations Per KM"/>
		<custom:searchBody>
		...
		<div class="chart_main">
			<div style="width:100%; height: 5%; font-size:large; font-weight: bolder; text-align: center;">Speeding Violations Per KM</div>
