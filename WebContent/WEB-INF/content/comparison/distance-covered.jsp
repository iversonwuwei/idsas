...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript" src="<%=basePath%>scripts/specific/comparison/distance-covered.js"></script>
    </head>
	<body>
		<custom:navigation father="Department Report" model="Distance Covered Trend" excelMethod="doExport();" />
		<form id="chartForm" action="<%=basePath%>comparison/distance-covered!exportExcel" method="post">
		<custom:searchBody>
		...
		<div class="chart_main">
			<div style="width:100%; height: 5%; font-size:large; font-weight: bolder; text-align: center;">Distance Covered</div>
