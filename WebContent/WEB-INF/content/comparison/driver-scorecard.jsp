...
<html>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>css/flot.css" />
		...
		<script language="javascript" type="text/javascript" src="<%=basePath%>scripts/specific/comparison/driver-scorecard.js"></script>
	</head>
	<body>
		<custom:navigation father="Driver Report" model="Driver Scorecard" />
		<custom:searchBody>
		...
		<div class="chart_main">
			<div style="width:100%; height: 5%; font-size:large; font-weight: bolder; text-align: center;">Driver Scorecard</div>
