...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>scripts/common/OpenLayers-2.12/OpenLayers.js" charset="UTF-8"></script>
				...
				socket.onmessage = function(event) {
					...
					if(gpsDataArr[0] == "gpsData") {
						...
						if(selectedTarget == 'all') {
							...
							addRoute(parseFloat(gpsDataArr[2]).toFixed(10), parseFloat(gpsDataArr[3]).toFixed(10));	//监控单独车辆时显示轨迹
						}
					//接到警告数据
				...
				<script type="text/javascript">
					...
					<s:iterator value="targetList" var="t" status="r">
						if("${t.targetType}" == "1") {	//fleet
							...
							content = "<span id=\"treeContent_${t.targetID}\" style=\"cursor:pointer;border-radius: 4px 4px 4px 4px;\" onclick=\"doSelectTarget('${t.targetName}')\">"
									+ "${t.targetName} "
									+ "</span>";
			...
			<div id="bottomMarkerDiv">
				<table style="width: 100%;">
					<tr>
						...
						<td>Police</td>
						<td><img src="<%=basePath%>scripts/common/OpenLayers-2.12/img/m-magenta.png" style="height: 30px;" align="absmiddle"/></td>
						<td>Sudden <br />Braking</td>
						<td><img src="<%=basePath%>scripts/common/OpenLayers-2.12/img/m-teal.png" style="height: 30px;" align="absmiddle"/></td>
						<td>Sudden <br />Acceleration</td>
						<td><img src="<%=basePath%>scripts/common/OpenLayers-2.12/img/m-yellow.png" style="height: 30px;" align="absmiddle"/></td>
						<td>Sudden <br />Left</td>
						<td><img src="<%=basePath%>scripts/common/OpenLayers-2.12/img/m-orange.png" style="height: 30px;" align="absmiddle"/></td>
						<td>Sudden <br />Right</td>
						<td><img src="<%=basePath%>scripts/common/OpenLayers-2.12/img/m-purple.png" style="height: 30px;" align="absmiddle"/></td>
						<td>Speeding</td>
						<td><img src="<%=basePath%>scripts/common/OpenLayers-2.12/img/m-gray.png" style="height: 30px;" align="absmiddle"/></td>
						<td>Neutral <br />Slide</td>
						<td><img src="<%=basePath%>scripts/common/OpenLayers-2.12/img/m-blue.png" style="height: 30px;" align="absmiddle"/></td>
						<td>Idle</td>
						<td><img src="<%=basePath%>scripts/common/OpenLayers-2.12/img/m-white.png" style="height: 30px;" align="absmiddle"/></td>
