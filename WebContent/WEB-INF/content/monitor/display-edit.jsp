...
<html>
	<head>
		...
		<script charset="UTF-8" type="text/javascript" src="<%=basePath%>scripts/specific/monitor/display.js"></script>
...
<input type="text" id="startDate" style="width: 127px;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', readOnly:true});this.blur();" />					
				...
				<tr>
					...
					<td style="text-align: left;" colspan="3">
								...
								<button class="button_input" onclick="checkSearch2();" style="width: 60px;">Search</button>
						
					</td>
				</tr>
				<!-- <tr>
					<td class="text_bg">EndDate:</td>
					<td style="text-align: left;">
						<label class="input_date">
							<input type="text" id="endDate" style="width: 127px;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:&quot;#F{$dp.$D('startDate')}&quot;, maxDate:'%y-%M-%d', readOnly:true});this.blur();" />
						</label>
					</td>
				</tr> -->
				<tr>
