...
<script charset="UTF-8" type="text/javascript" src="<%=basePath%>scripts/specific/task/google-map.js"></script>
	...
	<custom:navigation father="Task Management" model="Geo Fencing" operate="Edit" saveMethod="sub2();" homePath="task/google-fencing" />
	
	<form id="equip_form" action="<%=basePath%>task/google-fencing!create1" target="" method="post">  
	      ...
	      function sub2(){
	    	  ...
	    	  if(null != veh || "" != vehanem){
	    		  $.ajax({
			  			...
			  			url : basePath + "task/google-fencing!getveh1",
			  			success : function(data) {
			  				 if('[false]' == data){
