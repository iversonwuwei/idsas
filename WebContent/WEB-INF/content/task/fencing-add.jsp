...
<html>
	...
	<custom:navigation father="Task Management" model="Geo Fencing" operate="Add" saveMethod="sub2();" homePath="task/fencing" />
	
	<form id="equip_form" action="<%=basePath%>task/fencing!create" target="" method="post"> 
