...
<head>
	...
	<body>
		<custom:navigation father="Fault Analyzer" model="Fault Dictionary" operate="Edit" saveMethod="sub2();" homePath="analy/fault-dict" />
		<form action="<%=basePath%>analy/fault-dict!create" name="queryResult" method="post">
			<input type="hidden" name="faultcodeid" id="faultcodeid" value="${id}" /> 
