 ...
 *
 **/
function dhtmlXComboFromSelect_4(parent,size) {
	...
	var w = new dhtmlXCombo_4(z, parent.name, size,s_type, parent.tabIndex);
	var x = new Array();
	var sel = 0;
 ...
 *	@topic: 0
 **/
function dhtmlXCombo_4(parent,name,width,optionType,tabIndex){
	if(typeof(parent) == "string") {
		parent = document.getElementById(parent);
	}
	this.dhx_Event();
	this.optionType = (optionType != window['undefined'] && dhtmlXCombo_4_optionTypes[optionType]) ? optionType : 'default';
	this._optionObject = dhtmlXCombo_4_optionTypes[this.optionType];
	...
	if(parent.tagName == "SELECT") {
		dhtmlXComboFromSelect_4(parent);
	} else {
 ...
 *	@topic: 0
 **/
//dhtmlXCombo_4.prototype.setSize = function(new_size) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4.prototype.enableFilteringMode = function(mode, url, cache, autosubload) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4.prototype.setFilteringParam = function(name, value){
	if(!this._prs) {
		this._prs = [];
	}
 ...
 *	@topic: 1
 **/
dhtmlXCombo_4.prototype.disable = function(mode) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_4.prototype.readonly = function(mode,autosearch) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.getOption = function(value) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.getOptionByLabel = function(value) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.getOptionByIndex = function(ind) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.clearAll = function(all) {
	if(all) {
		this.setComboText("");
	}
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.deleteOption = function(value) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_4.prototype.render = function(mode) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.updateOption = function(oldvalue, avalue, atext, acss) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.addOption = function(options) {
...
dhtmlXCombo_4.prototype._addOption = function(attr) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.getIndexByValue = function(val) {
	for(var i=0; i<this.optionsArr.length; i++)
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.getIndexByText = function(text) {
	for(var i = 0; i < this.optionsArr.length; i++) {
 ...
 *	@topic: 2 
 **/
dhtmlXCombo_4.prototype.getSelectedValue = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.getComboText = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.setComboText = function(text) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.setComboValue = function(text) {
 ...
 **/
dhtmlXCombo_4.prototype.getActualValue = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.getSelectedText = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.getSelectedIndex = function() {
	for(var i=0; i<this.optionsArr.length; i++) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4.prototype._createSelf = function(selParent, name, width, tab) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4.prototype._positList = function() {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4.prototype.getPosition = function(oNode,pNode) {
	if(!pNode) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype._correctSelection = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.selectNext = function(step) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4.prototype._onKeyF = function(e) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4.prototype._onKey = function(e) {
	var that = this.parentNode.combo;
	(e || event).cancelBubble = true;
...
dhtmlXCombo_4.prototype._onKeyB = function(ev) {
	if(ev == "40") {  //down
		...
		if (this._filter) {
			getTenTires(this.getComboText().toUpperCase(),this);
		}
		for(var i = 0; i < this.optionsArr.length; i++) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4.prototype._onBlur = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.redrawOptions = function() {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_4.prototype.unSelectOption = function() {	
	if(this._selOption) {
 ...
 *	@type private
 **/
dhtmlXCombo_4.prototype._confirmSelection = function(data, status) {
...
dhtmlXCombo_4.prototype._resetSelection = function(data, status) {
 ...
 *     @topic: 1
 **/
dhtmlXCombo_4.prototype.selectOption = function(ind, filter, conf) {	  		 
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype._selectOption = function(e) {
	(e||event).cancelBubble = true;
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype.openSelect = function() { 
	if(this._disabled) {
		return;
	}
	this.closeAll();
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype._toggleSelect = function(e) {
	var that = this.combo;
...
dhtmlXCombo_4.prototype._fetchOptions = function(ind,text) {
	if(text == "") {
		this.closeAll();
 ...
 *	@topic: 2
 **/
dhtmlXCombo_4.prototype._IEFix = function(mode) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_4.prototype.closeAll = function() {
	if(window.dhx_glbSelectAr) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_4_defaultOption = function() {
	this.init();
};
 ...
 *	@topic: 4
 **/
dhtmlXCombo_4_defaultOption.prototype.init = function() {
	this.value = null;
	this.text = "";
	this.selected = false;
	this.css = "";
 ...
 *	@topic: 4
 **/
dhtmlXCombo_4_defaultOption.prototype.select = function(){
	if (this.content) ;
	this.content.className = "dhx_selected_option";
};

dhtmlXCombo_4_defaultOption.prototype.hide = function(mode){
    this.render().style.display=mode?"none":"";
 };

dhtmlXCombo_4_defaultOption.prototype.isHidden = function(){
 ...
 *	@topic: 4
 **/
dhtmlXCombo_4_defaultOption.prototype.deselect = function() {
	if(this.content) {
		this.render();
	}
 ...
 *	@topic: 4
 **/
dhtmlXCombo_4_defaultOption.prototype.setValue = function(attr){
 ...
 *	@topic: 4
 **/
dhtmlXCombo_4_defaultOption.prototype.render = function() {
	if(!this.content) {
 ...
 *     @topic: 4
 */
dhtmlXCombo_4_defaultOption.prototype.data = function(){
	if (this.content)
		return [this.value,this._ctext ? this._ctext : this.text];
};

dhtmlXCombo_4_defaultOption.prototype.DrawHeader = function(self, name, width, tab) {
...
dhtmlXCombo_4_defaultOption.prototype._DrawHeaderInput = function(self, name, width,tab) {
...
dhtmlXCombo_4_optionTypes['default'] = dhtmlXCombo_4_defaultOption;

/**
 * 注册事件
 * @return
 */
dhtmlXCombo_4.prototype.dhx_Event = function() {
