 ...
 *
 **/
function dhtmlXComboFromSelect_1(parent,size) {
	...
	var w = new dhtmlXCombo_1(z, parent.name, size,s_type, parent.tabIndex);
	var x = new Array();
	var sel = 0;
 ...
 *	@topic: 0
 **/
function dhtmlXCombo_1(parent,name,width,optionType,tabIndex){
	if(typeof(parent) == "string") {
		parent = document.getElementById(parent);
	}
	this.dhx_Event();
	this.optionType = (optionType != window['undefined'] && dhtmlXCombo_1_optionTypes[optionType]) ? optionType : 'default';
	this._optionObject = dhtmlXCombo_1_optionTypes[this.optionType];
	...
	if(parent.tagName == "SELECT") {
		dhtmlXComboFromSelect_1(parent);
	} else {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype.setSize = function(new_size) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype.enableFilteringMode = function(mode, url, cache, autosubload) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype.setFilteringParam = function(name, value){
	if(!this._prs) {
		this._prs = [];
	}
 ...
 *	@topic: 1
 **/
dhtmlXCombo_1.prototype.disable = function(mode) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_1.prototype.readonly = function(mode,autosearch) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.getOption = function(value) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.getOptionByLabel = function(value) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.getOptionByIndex = function(ind) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.clearAll = function(all) {
	if(all) {
		this.setComboText("");
	}
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.deleteOption = function(value) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_1.prototype.render = function(mode) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.updateOption = function(oldvalue, avalue, atext, acss) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.addOption = function(options) {
...
dhtmlXCombo_1.prototype._addOption = function(attr) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.getIndexByValue = function(val) {
	for(var i=0; i<this.optionsArr.length; i++)
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.getIndexByText = function(text) {
	for(var i = 0; i < this.optionsArr.length; i++) {
 ...
 *	@topic: 2 
 **/
dhtmlXCombo_1.prototype.getSelectedValue = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.getComboText = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.setComboText = function(text) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.setComboValue = function(text) {
 ...
 **/
dhtmlXCombo_1.prototype.getActualValue = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.getSelectedText = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.getSelectedIndex = function() {
	for(var i=0; i<this.optionsArr.length; i++) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype._createSelf = function(selParent, name, width, tab) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype._positList = function() {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype.getPosition = function(oNode,pNode) {
	if(!pNode) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype._correctSelection = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.selectNext = function(step) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype._onKeyF = function(e) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype._onKey = function(e) {
	var that = this.parentNode.combo;
	(e || event).cancelBubble = true;
...
dhtmlXCombo_1.prototype._onKeyB = function(ev) {
	if(ev == "40") {  //down
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1.prototype._onBlur = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.redrawOptions = function() {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_1.prototype.unSelectOption = function() {	
	if(this._selOption) {
 ...
 *	@type private
 **/
dhtmlXCombo_1.prototype._confirmSelection = function(data, status) {
...
dhtmlXCombo_1.prototype._resetSelection = function(data, status) {
 ...
 *     @topic: 1
 **/
dhtmlXCombo_1.prototype.selectOption = function(ind, filter, conf) {	  		 
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype._selectOption = function(e) {
	(e||event).cancelBubble = true;
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype.openSelect = function() { 
	if(this._disabled) {
		return;
	}
	this.closeAll();
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype._toggleSelect = function(e) {
	var that = this.combo;
...
dhtmlXCombo_1.prototype._fetchOptions = function(ind,text) {
	if(text == "") {
		this.closeAll();
 ...
 *	@topic: 2
 **/
dhtmlXCombo_1.prototype._IEFix = function(mode) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_1.prototype.closeAll = function() {
	if(window.dhx_glbSelectAr) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_1_defaultOption = function() {
	this.init();
};
 ...
 *	@topic: 4
 **/
dhtmlXCombo_1_defaultOption.prototype.init = function() {
	this.value = null;
	this.text = "";
	this.selected = false;
	this.css = "";
 ...
 *	@topic: 4
 **/
dhtmlXCombo_1_defaultOption.prototype.select = function(){
	if (this.content) ;
...
dhtmlXCombo_1_defaultOption.prototype.hide = function(mode){
    this.render().style.display=mode?"none":"";
 };

dhtmlXCombo_1_defaultOption.prototype.isHidden = function(){
...
dhtmlXCombo_1_defaultOption.prototype.deselect = function() {
	if(this.content) {
		this.render();
	}
 ...
 *	@topic: 4
 **/
dhtmlXCombo_1_defaultOption.prototype.setValue = function(attr){
 ...
 *	@topic: 4
 **/
dhtmlXCombo_1_defaultOption.prototype.render = function() {
	if(!this.content) {
 ...
 *     @topic: 4
 */
dhtmlXCombo_1_defaultOption.prototype.data = function(){
	if (this.content)
		return [this.value,this._ctext ? this._ctext : this.text];
};

dhtmlXCombo_1_defaultOption.prototype.DrawHeader = function(self, name, width, tab) {
...
dhtmlXCombo_1_defaultOption.prototype._DrawHeaderInput = function(self, name, width,tab) {
...
dhtmlXCombo_1_optionTypes['default'] = dhtmlXCombo_1_defaultOption;

/**
 * 注册事件
 * @return
 */
dhtmlXCombo_1.prototype.dhx_Event = function() {
