 ...
 *
 **/
function dhtmlXComboFromSelect_3(parent,size) {
	...
	var w = new dhtmlXCombo_3(z, parent.name, size,s_type, parent.tabIndex);
	var x = new Array();
	var sel = 0;
 ...
 *	@topic: 0
 **/
function dhtmlXCombo_3(parent,name,width,optionType,tabIndex){
	if(typeof(parent) == "string") {
		parent = document.getElementById(parent);
	}
	this.dhx_Event();
	this.optionType = (optionType != window['undefined'] && dhtmlXCombo_3_optionTypes[optionType]) ? optionType : 'default';
	this._optionObject = dhtmlXCombo_3_optionTypes[this.optionType];
	...
	if(parent.tagName == "SELECT") {
		dhtmlXComboFromSelect_3(parent);
	} else {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype.setSize = function(new_size) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype.enableFilteringMode = function(mode, url, cache, autosubload) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype.setFilteringParam = function(name, value){
	if(!this._prs) {
		this._prs = [];
	}
 ...
 *	@topic: 1
 **/
dhtmlXCombo_3.prototype.disable = function(mode) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_3.prototype.readonly = function(mode,autosearch) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.getOption = function(value) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.getOptionByLabel = function(value) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.getOptionByIndex = function(ind) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.clearAll = function(all) {
	if(all) {
		this.setComboText("");
	}
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.deleteOption = function(value) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_3.prototype.render = function(mode) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.updateOption = function(oldvalue, avalue, atext, acss) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.addOption = function(options) {
...
dhtmlXCombo_3.prototype._addOption = function(attr) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.getIndexByValue = function(val) {
	for(var i=0; i<this.optionsArr.length; i++)
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.getIndexByText = function(text) {
	for(var i = 0; i < this.optionsArr.length; i++) {
 ...
 *	@topic: 2 
 **/
dhtmlXCombo_3.prototype.getSelectedValue = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.getComboText = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.setComboText = function(text) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.setComboValue = function(text) {
 ...
 **/
dhtmlXCombo_3.prototype.getActualValue = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.getSelectedText = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.getSelectedIndex = function() {
	for(var i=0; i<this.optionsArr.length; i++) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype._createSelf = function(selParent, name, width, tab) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype._positList = function() {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype.getPosition = function(oNode,pNode) {
	if(!pNode) {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype._correctSelection = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.selectNext = function(step) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype._onKeyF = function(e) {
	...
	if(ev.keyCode == "13" || ev.keyCode == "9") {	//Enter || Tab
		...
		that.closeAll();
		this.parentNode._self.DOMelem_input.blur();
	} else if(ev.keyCode == "27") {		//Esc
		//that._resetSelection();   取消Esc选择上一次选项的功能
		that.closeAll();
	} else {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype._onKey = function(e) {
	var that = this.parentNode.combo;
	(e || event).cancelBubble = true;
	...
	if((ev != "13") && (ev != "9")) {	//!Enter && !Tab
		that.DOMlist.style.display="block";
...
dhtmlXCombo_3.prototype._onKeyB = function(ev) {
	if(ev == "40") {  //down
		...
		if (this._filter) {
			catchMaterials(this.getComboText().toUpperCase());
		}
		for(var i = 0; i < this.optionsArr.length; i++) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3.prototype._onBlur = function() {
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.redrawOptions = function() {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_3.prototype.unSelectOption = function() {	
	if(this._selOption) {
 ...
 *	@type private
 **/
dhtmlXCombo_3.prototype._confirmSelection = function(data, status) {
...
dhtmlXCombo_3.prototype._resetSelection = function(data, status) {
 ...
 *     @topic: 1
 **/
dhtmlXCombo_3.prototype.selectOption = function(ind, filter, conf) {	  		 
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype._selectOption = function(e) {
	(e||event).cancelBubble = true;
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype.openSelect = function() { 
	if(this._disabled) {
		return;
	}
	this.closeAll();
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype._toggleSelect = function(e) {
	var that = this.combo;
...
dhtmlXCombo_3.prototype._fetchOptions = function(ind,text) {
	if(text == "") {
		this.closeAll();
 ...
 *	@topic: 2
 **/
dhtmlXCombo_3.prototype._IEFix = function(mode) {
 ...
 *	@topic: 1
 **/
dhtmlXCombo_3.prototype.closeAll = function() {
	if(window.dhx_glbSelectAr) {
 ...
 *	@topic: 0
 **/
dhtmlXCombo_3_defaultOption = function() {
	this.init();
};
 ...
 *	@topic: 4
 **/
dhtmlXCombo_3_defaultOption.prototype.init = function() {
	this.value = null;
	this.text = "";
	this.selected = false;
	this.css = "";
 ...
 *	@topic: 4
 **/
dhtmlXCombo_3_defaultOption.prototype.select = function(){
	if (this.content) ;
	this.content.className = "dhx_selected_option";
};

dhtmlXCombo_3_defaultOption.prototype.hide = function(mode){
    this.render().style.display=mode?"none":"";
 };

dhtmlXCombo_3_defaultOption.prototype.isHidden = function(){
 ...
 *	@topic: 4
 **/
dhtmlXCombo_3_defaultOption.prototype.deselect = function() {
	if(this.content) {
		this.render();
	}
 ...
 *	@topic: 4
 **/
dhtmlXCombo_3_defaultOption.prototype.setValue = function(attr){
 ...
 *	@topic: 4
 **/
dhtmlXCombo_3_defaultOption.prototype.render = function() {
	if(!this.content) {
 ...
 *     @topic: 4
 */
dhtmlXCombo_3_defaultOption.prototype.data = function(){
	if (this.content)
		return [this.value,this._ctext ? this._ctext : this.text];
};

dhtmlXCombo_3_defaultOption.prototype.DrawHeader = function(self, name, width, tab) {
...
dhtmlXCombo_3_defaultOption.prototype._DrawHeaderInput = function(self, name, width,tab) {
...
dhtmlXCombo_3_optionTypes['default'] = dhtmlXCombo_3_defaultOption;

/**
 * 注册事件
 * @return
 */
dhtmlXCombo_3.prototype.dhx_Event = function() {
