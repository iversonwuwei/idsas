...
/**
 * @description System Settings-POI-controller
 * @author Liu Jun
 * @since 2014年7月16日 上午9:28:46
 */
public class PoiConfController extends URLSupport<PoiConf> {
	
	private static final long serialVersionUID = -5713389339536373192L;
	...
	public String save() throws IOException {
		try {
			...
			baseMgr.save(poi);
			Utils.renderHtml(Constants.SUCCESS[0] + Utils.getBasePath() + "system/poi-conf?editble=1&highlight=" + poi.getPoiid() + Constants.SUCCESS[1]);
		} catch (Exception e) {
