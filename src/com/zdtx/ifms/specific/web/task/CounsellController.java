...
public class CounsellController extends ReportBase<CounsellView> {
	...
	private List<KeyAndValue> userList = new ArrayList<KeyAndValue>();
	...
	public String create() throws IOException {
		...
		try {
			...
			baseMgr.save(cs);
			out.print(Constants.SUCCESS[0] + "counsell!index?highlight="
	...
	public List<KeyAndValue> getUserList() {
		return userList;
	}

	public void setUserList(List<KeyAndValue> userList) {
