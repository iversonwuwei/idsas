...
import com.zdtx.ifms.specific.vo.comparison.DailySpeedingVO;

/**
 * @ClassName: DailySpeedingManager
 * @Description: comparison-Daily Speeding Violations Per KM-manager
 * @author Leon Liu
 * @date 2013-9-26 15:34:16
 * @version V1.0
 */

@Service
@Transactional
public class DailySpeedingManager {
	...
	public List<DailySpeedingVO> getBatch(ChartVO vo) {
		String sql = "SELECT BEH_SP/RUNKM AS BEHSP,"
		...
		query.addScalar("behSP", DoubleType.INSTANCE);
		...
		query.setResultTransformer(Transformers
				.aliasToBean(DailySpeedingVO.class));
		return (List<DailySpeedingVO>) query.list();
	}
}